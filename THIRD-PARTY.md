...
- `static/js/hx-live-4.0.0.js` — the hx-live extension. 0BSD.
...
- `contacts.json`, the routes and the templates — from *Hypermedia Systems*
  (Gross, Stepinski, Akşimşek), whose sample application is published under
...
project's. dj-hx vendors `hxlint.py` and `hx_vocab.py` from here.
